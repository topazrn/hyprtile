...
Add your theme name into [the schema](dist/schemas/org.gnome.shell.extensions.hyprtile.gschema.xml) under `themes`.
...
You must add `hyprtile-[THEME NAME]__` to the beginning of classes outside the main container.
